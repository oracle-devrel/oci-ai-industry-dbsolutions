...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(62124331163085017)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(41367270571659870)
,p_plug_template_id=>wwv_flow_imp.id(62124331163085017)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(41367791541659869)
,p_plug_template_id=>wwv_flow_imp.id(62124331163085017)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(41368247099659869)
,p_plug_template_id=>wwv_flow_imp.id(62124331163085017)
,p_name=>'Sub Regions'
