...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(62150487337085034)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(41435138958659817)
,p_plug_template_id=>wwv_flow_imp.id(62150487337085034)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(41435630033659817)
,p_plug_template_id=>wwv_flow_imp.id(62150487337085034)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(41436184014659817)
,p_plug_template_id=>wwv_flow_imp.id(62150487337085034)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(41436623482659817)
,p_plug_template_id=>wwv_flow_imp.id(62150487337085034)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(41437140272659816)
,p_plug_template_id=>wwv_flow_imp.id(62150487337085034)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
