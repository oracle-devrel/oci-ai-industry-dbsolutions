...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(62164025460085042)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(41469657229659790)
,p_plug_template_id=>wwv_flow_imp.id(62164025460085042)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(41470196311659790)
,p_plug_template_id=>wwv_flow_imp.id(62164025460085042)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(41470627703659789)
,p_plug_template_id=>wwv_flow_imp.id(62164025460085042)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(41471181969659789)
,p_plug_template_id=>wwv_flow_imp.id(62164025460085042)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(41471677691659789)
,p_plug_template_id=>wwv_flow_imp.id(62164025460085042)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(41472124861659789)
,p_plug_template_id=>wwv_flow_imp.id(62164025460085042)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(41472645271659788)
,p_plug_template_id=>wwv_flow_imp.id(62164025460085042)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(41473190757659788)
,p_plug_template_id=>wwv_flow_imp.id(62164025460085042)
,p_name=>'Sub Regions'
