...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(62101894293084999)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(41308475822659928)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(41308932757659928)
,p_page_template_id=>wwv_flow_imp.id(62101894293084999)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(41309481057659927)
,p_page_template_id=>wwv_flow_imp.id(62101894293084999)
