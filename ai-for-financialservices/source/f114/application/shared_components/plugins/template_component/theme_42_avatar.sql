...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(62259035783085121)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41695003786659518)
,p_plugin_id=>wwv_flow_imp.id(62259035783085121)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41695596124659515)
,p_plugin_attribute_id=>wwv_flow_imp.id(41695003786659518)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41696173203659513)
,p_plugin_attribute_id=>wwv_flow_imp.id(41695003786659518)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41696726265659512)
,p_plugin_attribute_id=>wwv_flow_imp.id(41695003786659518)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41697347405659510)
,p_plugin_id=>wwv_flow_imp.id(62259035783085121)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(41695003786659518)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41697897432659509)
,p_plugin_id=>wwv_flow_imp.id(62259035783085121)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41698344927659507)
,p_plugin_id=>wwv_flow_imp.id(62259035783085121)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41698884746659506)
,p_plugin_id=>wwv_flow_imp.id(62259035783085121)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41699394544659505)
,p_plugin_id=>wwv_flow_imp.id(62259035783085121)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41699894621659505)
,p_plugin_attribute_id=>wwv_flow_imp.id(41699394544659505)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41700475283659504)
,p_plugin_attribute_id=>wwv_flow_imp.id(41699394544659505)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41701044752659502)
,p_plugin_attribute_id=>wwv_flow_imp.id(41699394544659505)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41701691331659501)
,p_plugin_attribute_id=>wwv_flow_imp.id(41699394544659505)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41702287992659500)
,p_plugin_id=>wwv_flow_imp.id(62259035783085121)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41702732697659499)
,p_plugin_attribute_id=>wwv_flow_imp.id(41702287992659500)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41703376400659498)
,p_plugin_attribute_id=>wwv_flow_imp.id(41702287992659500)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41703950360659497)
,p_plugin_attribute_id=>wwv_flow_imp.id(41702287992659500)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41704545279659494)
,p_plugin_attribute_id=>wwv_flow_imp.id(41702287992659500)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41705185970659493)
,p_plugin_attribute_id=>wwv_flow_imp.id(41702287992659500)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41705766998659492)
,p_plugin_attribute_id=>wwv_flow_imp.id(41702287992659500)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41706384575659490)
,p_plugin_attribute_id=>wwv_flow_imp.id(41702287992659500)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41706968663659489)
,p_plugin_id=>wwv_flow_imp.id(62259035783085121)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1862309811724198873)
,p_plugin_id=>wwv_flow_imp.id(62259035783085121)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
