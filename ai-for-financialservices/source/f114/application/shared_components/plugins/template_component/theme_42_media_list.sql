...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(62308851236085212)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1841803771940542924)
,p_plugin_id=>wwv_flow_imp.id(62308851236085212)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1841803216928542923)
,p_plugin_id=>wwv_flow_imp.id(62308851236085212)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41786499979659272)
,p_plugin_id=>wwv_flow_imp.id(62308851236085212)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41786938934659270)
,p_plugin_id=>wwv_flow_imp.id(62308851236085212)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41787412305659270)
,p_plugin_id=>wwv_flow_imp.id(62308851236085212)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41787931810659269)
,p_plugin_id=>wwv_flow_imp.id(62308851236085212)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41788434663659268)
,p_plugin_id=>wwv_flow_imp.id(62308851236085212)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(41787412305659270)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1841803771940542924)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41788988351659267)
,p_plugin_attribute_id=>wwv_flow_imp.id(41788434663659268)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41789509338659267)
,p_plugin_attribute_id=>wwv_flow_imp.id(41788434663659268)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41790138671659266)
,p_plugin_attribute_id=>wwv_flow_imp.id(41788434663659268)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41790761139659265)
,p_plugin_id=>wwv_flow_imp.id(62308851236085212)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(41788434663659268)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41791207735659265)
,p_plugin_id=>wwv_flow_imp.id(62308851236085212)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41791755729659264)
,p_plugin_id=>wwv_flow_imp.id(62308851236085212)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41792241953659263)
,p_plugin_id=>wwv_flow_imp.id(62308851236085212)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41792728044659263)
,p_plugin_id=>wwv_flow_imp.id(62308851236085212)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41793294219659262)
,p_plugin_attribute_id=>wwv_flow_imp.id(41792728044659263)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41793826976659261)
,p_plugin_attribute_id=>wwv_flow_imp.id(41792728044659263)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41794425823659260)
,p_plugin_attribute_id=>wwv_flow_imp.id(41792728044659263)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41795049884659259)
,p_plugin_attribute_id=>wwv_flow_imp.id(41792728044659263)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41795681780659258)
,p_plugin_id=>wwv_flow_imp.id(62308851236085212)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(41787931810659269)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1841803216928542923)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41796184414659257)
,p_plugin_id=>wwv_flow_imp.id(62308851236085212)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41796585250659256)
,p_plugin_id=>wwv_flow_imp.id(62308851236085212)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41797095498659256)
,p_plugin_id=>wwv_flow_imp.id(62308851236085212)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41797578898659255)
,p_plugin_id=>wwv_flow_imp.id(62308851236085212)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41798072314659254)
,p_plugin_id=>wwv_flow_imp.id(62308851236085212)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41798545870659253)
,p_plugin_attribute_id=>wwv_flow_imp.id(41798072314659254)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41799162938659252)
,p_plugin_attribute_id=>wwv_flow_imp.id(41798072314659254)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41799703156659251)
,p_plugin_id=>wwv_flow_imp.id(62308851236085212)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41800261630659251)
,p_plugin_attribute_id=>wwv_flow_imp.id(41799703156659251)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41800866349659250)
,p_plugin_attribute_id=>wwv_flow_imp.id(41799703156659251)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41801492374659249)
,p_plugin_attribute_id=>wwv_flow_imp.id(41799703156659251)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41802027499659248)
,p_plugin_id=>wwv_flow_imp.id(62308851236085212)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41802546812659247)
,p_plugin_attribute_id=>wwv_flow_imp.id(41802027499659248)
,p_display_sequence=>10
,p_display_value=>'2 Column Grid'
,p_return_value=>'t-MediaList--cols t-MediaList--2cols'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41803173173659246)
,p_plugin_attribute_id=>wwv_flow_imp.id(41802027499659248)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41803759684659245)
,p_plugin_attribute_id=>wwv_flow_imp.id(41802027499659248)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41804344999659244)
,p_plugin_attribute_id=>wwv_flow_imp.id(41802027499659248)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41804970048659243)
,p_plugin_attribute_id=>wwv_flow_imp.id(41802027499659248)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41805577842659241)
,p_plugin_id=>wwv_flow_imp.id(62308851236085212)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41806070818659240)
,p_plugin_attribute_id=>wwv_flow_imp.id(41805577842659241)
,p_display_sequence=>10
,p_display_value=>'Large'
,p_return_value=>'t-MediaList--large force-fa-lg'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41806653452659239)
,p_plugin_id=>wwv_flow_imp.id(62308851236085212)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1862530358420115489)
,p_plugin_id=>wwv_flow_imp.id(62308851236085212)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
