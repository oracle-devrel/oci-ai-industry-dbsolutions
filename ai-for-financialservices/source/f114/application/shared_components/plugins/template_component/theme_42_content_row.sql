...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(62286523900085176)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1968977760122731067)
,p_plugin_id=>wwv_flow_imp.id(62286523900085176)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1968977205110731066)
,p_plugin_id=>wwv_flow_imp.id(62286523900085176)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1712085141380457553)
,p_plugin_id=>wwv_flow_imp.id(62286523900085176)
,p_title=>'Appearance'
,p_display_sequence=>30
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41741449180659368)
,p_plugin_id=>wwv_flow_imp.id(62286523900085176)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41741971748659366)
,p_plugin_id=>wwv_flow_imp.id(62286523900085176)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41742405626659365)
,p_plugin_id=>wwv_flow_imp.id(62286523900085176)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41742978226659365)
,p_plugin_id=>wwv_flow_imp.id(62286523900085176)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41743405305659363)
,p_plugin_id=>wwv_flow_imp.id(62286523900085176)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41743998278659362)
,p_plugin_id=>wwv_flow_imp.id(62286523900085176)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41744430890659360)
,p_plugin_id=>wwv_flow_imp.id(62286523900085176)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(41743405305659363)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1968977760122731067)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41744919644659360)
,p_plugin_attribute_id=>wwv_flow_imp.id(41744430890659360)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41745558091659359)
,p_plugin_attribute_id=>wwv_flow_imp.id(41744430890659360)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41746165023659358)
,p_plugin_attribute_id=>wwv_flow_imp.id(41744430890659360)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41746764726659358)
,p_plugin_id=>wwv_flow_imp.id(62286523900085176)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(41744430890659360)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41747132736659357)
,p_plugin_id=>wwv_flow_imp.id(62286523900085176)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41747667111659356)
,p_plugin_id=>wwv_flow_imp.id(62286523900085176)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41748171794659356)
,p_plugin_id=>wwv_flow_imp.id(62286523900085176)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41748612509659355)
,p_plugin_id=>wwv_flow_imp.id(62286523900085176)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41749139504659354)
,p_plugin_attribute_id=>wwv_flow_imp.id(41748612509659355)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41749717912659354)
,p_plugin_attribute_id=>wwv_flow_imp.id(41748612509659355)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41750343907659353)
,p_plugin_attribute_id=>wwv_flow_imp.id(41748612509659355)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41750959617659352)
,p_plugin_attribute_id=>wwv_flow_imp.id(41748612509659355)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41751567673659351)
,p_plugin_id=>wwv_flow_imp.id(62286523900085176)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(41743998278659362)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1968977205110731066)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41752086139659350)
,p_plugin_id=>wwv_flow_imp.id(62286523900085176)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41752592582659349)
,p_plugin_id=>wwv_flow_imp.id(62286523900085176)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41753039518659348)
,p_plugin_id=>wwv_flow_imp.id(62286523900085176)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41753599548659347)
,p_plugin_id=>wwv_flow_imp.id(62286523900085176)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41754073646659346)
,p_plugin_id=>wwv_flow_imp.id(62286523900085176)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41754558644659345)
,p_plugin_attribute_id=>wwv_flow_imp.id(41754073646659346)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41755137279659344)
,p_plugin_attribute_id=>wwv_flow_imp.id(41754073646659346)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41755707554659343)
,p_plugin_id=>wwv_flow_imp.id(62286523900085176)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41756267513659343)
,p_plugin_attribute_id=>wwv_flow_imp.id(41755707554659343)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41756841149659342)
,p_plugin_attribute_id=>wwv_flow_imp.id(41755707554659343)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41757447119659341)
,p_plugin_attribute_id=>wwv_flow_imp.id(41755707554659343)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41758013055659340)
,p_plugin_attribute_id=>wwv_flow_imp.id(41755707554659343)
,p_display_sequence=>40
,p_display_value=>'No Shape'
,p_return_value=>'t-Avatar--noShape'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41758653017659339)
,p_plugin_id=>wwv_flow_imp.id(62286523900085176)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41759181015659338)
,p_plugin_attribute_id=>wwv_flow_imp.id(41758653017659339)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41759749126659337)
,p_plugin_attribute_id=>wwv_flow_imp.id(41758653017659339)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41760311428659337)
,p_plugin_attribute_id=>wwv_flow_imp.id(41758653017659339)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41760912803659336)
,p_plugin_attribute_id=>wwv_flow_imp.id(41758653017659339)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41761512044659335)
,p_plugin_attribute_id=>wwv_flow_imp.id(41758653017659339)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41762177959659333)
,p_plugin_attribute_id=>wwv_flow_imp.id(41758653017659339)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41762753514659331)
,p_plugin_attribute_id=>wwv_flow_imp.id(41758653017659339)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41763342641659330)
,p_plugin_id=>wwv_flow_imp.id(62286523900085176)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41763822773659329)
,p_plugin_attribute_id=>wwv_flow_imp.id(41763342641659330)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41764454671659328)
,p_plugin_attribute_id=>wwv_flow_imp.id(41763342641659330)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41765055581659327)
,p_plugin_attribute_id=>wwv_flow_imp.id(41763342641659330)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41765692728659326)
,p_plugin_id=>wwv_flow_imp.id(62286523900085176)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41766105749659325)
,p_plugin_attribute_id=>wwv_flow_imp.id(41765692728659326)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-ContentRow-badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41766726284659323)
,p_plugin_attribute_id=>wwv_flow_imp.id(41765692728659326)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41767390099659322)
,p_plugin_attribute_id=>wwv_flow_imp.id(41765692728659326)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41767980206659321)
,p_plugin_attribute_id=>wwv_flow_imp.id(41765692728659326)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41768589873659319)
,p_plugin_id=>wwv_flow_imp.id(62286523900085176)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41769091580659319)
,p_plugin_attribute_id=>wwv_flow_imp.id(41768589873659319)
,p_display_sequence=>10
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41769658088659318)
,p_plugin_id=>wwv_flow_imp.id(62286523900085176)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41770118575659317)
,p_plugin_attribute_id=>wwv_flow_imp.id(41769658088659318)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41770726417659317)
,p_plugin_attribute_id=>wwv_flow_imp.id(41769658088659318)
,p_display_sequence=>20
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41771309635659316)
,p_plugin_id=>wwv_flow_imp.id(62286523900085176)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41771886302659315)
,p_plugin_id=>wwv_flow_imp.id(62286523900085176)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41772371930659314)
,p_plugin_id=>wwv_flow_imp.id(62286523900085176)
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_attribute_group_id=>wwv_flow_imp.id(1712085141380457553)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41772880602659313)
,p_plugin_id=>wwv_flow_imp.id(62286523900085176)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(41773315957659312)
,p_plugin_attribute_id=>wwv_flow_imp.id(41772880602659313)
,p_display_sequence=>10
,p_display_value=>'Compact'
,p_return_value=>'t-ContentRow--styleCompact'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41773938561659311)
,p_plugin_id=>wwv_flow_imp.id(62286523900085176)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(41774457276659310)
,p_plugin_id=>wwv_flow_imp.id(62286523900085176)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1870738234106978503)
,p_plugin_id=>wwv_flow_imp.id(62286523900085176)
,p_name=>'Button'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1870739493626982651)
,p_plugin_id=>wwv_flow_imp.id(62286523900085176)
,p_name=>'Menu'
,p_type=>'MENU'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1553240135442794251)
,p_plugin_id=>wwv_flow_imp.id(62286523900085176)
,p_name=>'Badge Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1857144605432571770)
,p_plugin_id=>wwv_flow_imp.id(62286523900085176)
,p_name=>'Title Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1857823906162654874)
,p_plugin_id=>wwv_flow_imp.id(62286523900085176)
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1870736299039933517)
,p_plugin_id=>wwv_flow_imp.id(62286523900085176)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1870737632429947374)
,p_plugin_id=>wwv_flow_imp.id(62286523900085176)
